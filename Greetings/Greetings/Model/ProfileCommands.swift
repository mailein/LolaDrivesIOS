...
enum ProfileCommands{
    static let commands: [CommandItem] = [
        ...
        CommandItem(pid: "4F", name: "MAX VALUES", unit: "LAMBDA", obdCommand: LTOBD2PID_MAX_VALUE_FUEL_AIR_EQUIVALENCE_RATIO_4F.forMode1()),
        CommandItem(pid: "4F", name: "MAX VALUES", unit: "V", obdCommand:  LTOBD2PID_MAX_VALUE_OXYGEN_SENSOR_VOLTAGE_4F.forMode1()),
        CommandItem(pid: "4F", name: "MAX VALUES", unit: "mA", obdCommand: LTOBD2PID_MAX_VALUE_OXYGEN_SENSOR_CURRENT_4F.forMode1()),
        CommandItem(pid: "4F", name: "MAX VALUES", unit: "kPa", obdCommand: LTOBD2PID_MAX_VALUE_INTAKE_MAP_4F.forMode1()),
