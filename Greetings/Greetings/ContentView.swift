...
//    output u_va_pct: Float64 @1Hz := u_va_pct_h.aggregate(over_discrete: 7200, using: max).defaults(to: 0.0)
//
//    output r_va_pct_h : Float64 @1Hz := if r_a_ge_01 then va else 200000.0  //percentile95(va[-N:0 | r_a_ge_01])
//    output r_va_pct: Float64 @1Hz := r_va_pct_h.aggregate(over_discrete: 7200, using: max).defaults(to: 0.0)
//
//    output m_va_pct_h : Float64 @1Hz := if m_a_ge_01 then va else 200000.0  //percentile95(va[-N:0 | m_a_ge_01])
//    output m_va_pct: Float64 @1Hz := m_va_pct_h.aggregate(over_discrete: 7200, using: max).defaults(to: 0.0)
//
